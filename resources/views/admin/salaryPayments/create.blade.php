...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Salary Payment</h2>

        <p class="admin-page-subtitle">
            Create teacher, staff or manager salary payment
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.salary-payments.store') }}">
    @csrf
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Select employee type and employee</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    <label class="field-label" for="employee_type">
                ...
                <div class="field-group">
                    <label class="field-label" for="salary_month">
                        Salary Month <span class="req">*</span>
                    </label>
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">Leave blank for auto salary slip number.</p>
                    @endif
                </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Basic salary, bonus, deduction and paid amount</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    <label class="field-label" for="basic_salary">
                        Basic Salary <span class="req">*</span>
                    </label>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="paid_by_id" id="paid_by_id" class="field-input {{ $errors->has('paid_by_id') ? 'error' : '' }}">
                            @foreach($users as $id => $user)
                                <option value="{{ $id }}" {{ old('paid_by_id', auth()->id()) == $id ? 'selected' : '' }}>
                                    {{ $user }}
                                </option>
                            @endforeach
                        </select>
