...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Inventory Item</h2>

        <p class="admin-page-subtitle">
            Add stock item with branch, category, unit, opening stock and low stock alert level
        </p>
    </div>
</div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Basic item name, branch, category and unit</p>
                </div>
            </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Opening stock, alert level and item cost</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="form-info-box">
                    <p>
                        <i class="fas fa-info-circle"></i>
                        Opening stock first available quantity maana jayega. Future stock in/out transaction se update hoga.
                    </p>
                </div>
        ...
        <div class="form-card" style="grid-column:1/-1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Review stock level, value and item status before saving</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="stats-grid" style="margin-bottom:0;">
                    ...
                    <div class="stat-card">
                        ...
                        <p class="stat-value" id="previewStatus" style="font-size:22px;">Active</p>
                    </div>
                </div>
...
function updateInventoryPreview() {
    ...
    document.getElementById('previewStatus').innerText = formatText(status ? status.value : 'active');
}
