    ...
    <div class="admin-form-grid">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                @include('admin.partials.profile-user-select', ['selectedUserId' => $staff->user_id])

                <div class="field-group">
                    <label class="field-label" for="account_name">Account Name <span class="req">*</span></label>
                    <div class="input-icon-wrap">
                        <i class="fas fa-user icon"></i>
                        <input type="text" name="account_name" id="account_name" value="{{ old('account_name', $staff->user->name ?? '') }}" placeholder="Staff name" class="field-input {{ $errors->has('account_name') ? 'error' : '' }}">
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="email" name="account_email" id="account_email" value="{{ old('account_email', $staff->user->email ?? '') }}" placeholder="staff@example.com" class="field-input {{ $errors->has('account_email') ? 'error' : '' }}">
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap"><i class="fas fa-mobile-alt icon"></i><input type="text" name="device_id" id="device_id" value="{{ old('device_id', $staff->device_id) }}" placeholder="Device ID" class="field-input {{ $errors->has('device_id') ? 'error' : '' }}"></div>
