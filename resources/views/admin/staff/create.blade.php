...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Staff</h2>

        <p class="admin-page-subtitle">
            Create staff profile and attach branch, photo and documents
        </p>
    </div>
</div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Basic staff details</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap"><i class="fas fa-envelope icon"></i><input type="email" name="account_email" id="account_email" value="{{ old('account_email') }}" placeholder="staff@example.com" class="field-input {{ $errors->has('account_email') ? 'error' : '' }}"></div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Designation, department and salary</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               placeholder="Example: Receptionist, Accountant"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               placeholder="Example: Accounts, Reception, Admin"
        ...
        <div class="form-card" style="grid-column: 1 / -1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Upload staff photo and documents</p>
                </div>
            </div>
