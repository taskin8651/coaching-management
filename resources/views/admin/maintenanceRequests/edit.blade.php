...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Maintenance</h2>

        <p class="admin-page-subtitle">
            Update maintenance request, assigned person, priority, status and repair notes
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.maintenance-requests.update', $maintenanceRequest->id) }}">
    @csrf
    @method('PUT')
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update issue title, category and branch details</p>
                </div>
            </div>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="branch_id"
                            ...
                            @foreach($branches as $id => $name)
                                <option value="{{ $id }}" {{ old('branch_id', $maintenanceRequest->branch_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update assigned person, priority and current status</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="priority"
                            ...
                            <option value="low" {{ old('priority', $maintenanceRequest->priority) === 'low' ? 'selected' : '' }}>
                                Low
                            </option>

                            <option value="medium" {{ old('priority', $maintenanceRequest->priority) === 'medium' ? 'selected' : '' }}>
                                Medium
                            </option>

                            <option value="high" {{ old('priority', $maintenanceRequest->priority) === 'high' ? 'selected' : '' }}>
                                High
                            </option>

                            <option value="urgent" {{ old('priority', $maintenanceRequest->priority) === 'urgent' ? 'selected' : '' }}>
                                Urgent
                            </option>
                        </select>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="status"
                            ...
                            <option value="open" {{ old('status', $maintenanceRequest->status) === 'open' ? 'selected' : '' }}>
                                Open
                            </option>

                            <option value="assigned" {{ old('status', $maintenanceRequest->status) === 'assigned' ? 'selected' : '' }}>
                                Assigned
                            </option>

                            <option value="in_progress" {{ old('status', $maintenanceRequest->status) === 'in_progress' ? 'selected' : '' }}>
                                In Progress
                            </option>

                            <option value="resolved" {{ old('status', $maintenanceRequest->status) === 'resolved' ? 'selected' : '' }}>
                                Resolved
                            </option>

                            <option value="closed" {{ old('status', $maintenanceRequest->status) === 'closed' ? 'selected' : '' }}>
                                Closed
                            </option>
                        </select>
                    </div>
                ...
                <div class="stats-grid" style="margin-bottom:0;">
                    <div class="stat-card">
                        ...
                        <p class="stat-value" id="previewPriority" style="font-size:22px;">-</p>
                    </div>
        ...
        <div class="form-card" style="grid-column:1/-1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update issue description and repair progress</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap textarea-wrap">
                        ...
                        <textarea name="description"
                                  ...
                                  class="field-input {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $maintenanceRequest->description) }}</textarea>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap textarea-wrap">
                        ...
                        <textarea name="repair_notes"
                                  ...
                                  class="field-input {{ $errors->has('repair_notes') ? 'error' : '' }}">{{ old('repair_notes', $maintenanceRequest->repair_notes) }}</textarea>
                    </div>
...
function updateMaintenancePreview() {
    ...
    document.getElementById('previewPriority').innerText = formatText(priority ? priority.value : '');
