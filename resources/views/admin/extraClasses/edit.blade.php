...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Extra Class</h2>

        <p class="admin-page-subtitle">
            Update extra class details, approval status and salary amount
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.extra-classes.update', $extraClass->id) }}">
    @csrf
    @method('PUT')
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="teacher_id"
                            ...
                            @foreach($teachers as $id => $name)
                                <option value="{{ $id }}" {{ old('teacher_id', $extraClass->teacher_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="batch_id"
                            ...
                            @foreach($batches as $id => $name)
                                <option value="{{ $id }}" {{ old('batch_id', $extraClass->batch_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="subject_id"
                            ...
                            @foreach($subjects as $id => $name)
                                <option value="{{ $id }}" {{ old('subject_id', $extraClass->subject_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update extra class date and timing</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               ...
                               id="class_date"
                               required
                               value="{{ old('class_date', $extraClass->class_date ? \Carbon\Carbon::parse($extraClass->class_date)->format('Y-m-d') : date('Y-m-d')) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="time"
                               ...
                               id="start_time"
                               required
                               value="{{ old('start_time', $extraClass->start_time) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="time"
                               ...
                               id="end_time"
                               required
                               value="{{ old('end_time', $extraClass->end_time) }}"
        ...
        <div class="form-card" style="grid-column:1/-1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update approval status, salary amount, reason and remarks</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="approval_status"
                            ...
                            <option value="pending" {{ old('approval_status', $extraClass->approval_status) === 'pending' ? 'selected' : '' }}>
                                Pending
                            </option>
                            <option value="approved" {{ old('approval_status', $extraClass->approval_status) === 'approved' ? 'selected' : '' }}>
                                Approved
                            </option>
                            <option value="rejected" {{ old('approval_status', $extraClass->approval_status) === 'rejected' ? 'selected' : '' }}>
                                Rejected
                            </option>
                        </select>
                    </div>
                    ...
                    @else
                        <p class="field-hint">
                            <i class="fas fa-info-circle"></i>
                            Approved hone par hi salary amount calculation me count hoga.
                        </p>
                    @endif
                </div>

                <div class="field-group">
                    <label class="field-label" for="salary_amount">
                        Salary Amount
                    </label>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               ...
                               name="salary_amount"
                               id="salary_amount"
                               value="{{ old('salary_amount', $extraClass->salary_amount ?? 0) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap textarea-wrap">
                        ...
                        <textarea name="reason"
                                  ...
                                  class="field-input {{ $errors->has('reason') ? 'error' : '' }}">{{ old('reason', $extraClass->reason) }}</textarea>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap textarea-wrap">
                        ...
                        <textarea name="remarks"
                                  ...
                                  class="field-input {{ $errors->has('remarks') ? 'error' : '' }}">{{ old('remarks', $extraClass->remarks) }}</textarea>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    cascadeByParent(subjectSelect, batchSelect, subjectsByBatch, {
        ...
        keepValue: @json(old('subject_id', $extraClass->subject_id)),
    });
