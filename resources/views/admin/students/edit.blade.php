        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap"><i class="fas fa-mobile-alt icon"></i><input type="text" name="device_id" id="device_id" value="{{ old('device_id', $student->device_id) }}" placeholder="Device ID" class="field-input {{ $errors->has('device_id') ? 'error' : '' }}"></div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    cascadeByParent(courseSelect, branchSelect, coursesByBranch, {
        ...
        keepValue: @json(old('course_id', $student->course_id)),
    });

    cascadeCheckboxGrid(batchGrid, branchSelect, courseSelect, batchesByBranchCourse, {
        name: 'batch_ids[]',
        keepValue: @json(old('batch_ids', $selectedBatchIds)),
