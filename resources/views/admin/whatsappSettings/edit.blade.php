...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit WhatsApp Setting</h2>

        <p class="admin-page-subtitle">
            Update WhatsApp API, sender number, biometric device token and active status
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.whatsapp-settings.update', $setting->id) }}">
    @csrf
    @method('PUT')
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update provider, API URL and authentication token</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="api_provider"
                               id="api_provider"
                               value="{{ old('api_provider', $setting->api_provider) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="url"
                               name="api_base_url"
                               id="api_base_url"
                               value="{{ old('api_base_url', $setting->api_base_url) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap textarea-wrap">
                        ...
                        <textarea name="api_key"
                                  ...
                                  class="field-input {{ $errors->has('api_key') ? 'error' : '' }}">{{ old('api_key', $setting->api_key) }}</textarea>
                    </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Update sender number, biometric token and status</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="sender_number"
                               id="sender_number"
                               value="{{ old('sender_number', $setting->sender_number) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('biometric_device_token', $setting->biometric_device_token) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="status"
                            ...
                            <option value="active" {{ old('status', $setting->status) === 'active' ? 'selected' : '' }}>
                                Active
                            </option>
        ...
        <div class="form-card" style="grid-column:1/-1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Review provider, sender and current status before updating</p>
                </div>
            </div>
