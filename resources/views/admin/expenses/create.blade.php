...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Expense</h2>

        <p class="admin-page-subtitle">
            Add branch-wise expense, bill and payment details
        </p>
    </div>
</div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Basic expense information</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('title') }}"
                               required
                               placeholder="Example: Office Rent, Electricity Bill"
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Payment mode, date and paid by</p>
                </div>
            </div>
        ...
        <div class="form-card" style="grid-column: 1 / -1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Vendor, bill number and notes</p>
                </div>
            </div>
