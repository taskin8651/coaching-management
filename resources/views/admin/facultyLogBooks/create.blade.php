...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Add teacher lecture log, actual class timing, topic taught and approval status
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.faculty-log-books.store') }}">
    @csrf
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Scheduled time and actual teaching time</p>
                </div>
            </div>
        ...
        <div class="form-card" style="grid-column:1/-1;">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Set log status, approval status and remarks</p>
                </div>
            </div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="log_status"
                            ...
                            <option value="submitted" {{ old('log_status', 'submitted') === 'submitted' ? 'selected' : '' }}>
                                Submitted
                            </option>
                            <option value="draft" {{ old('log_status') === 'draft' ? 'selected' : '' }}>
                                Draft
                            </option>
                            <option value="missed" {{ old('log_status') === 'missed' ? 'selected' : '' }}>
                                Missed
                            </option>
                            <option value="late_entry" {{ old('log_status') === 'late_entry' ? 'selected' : '' }}>
                                Late Entry
                            </option>
                        </select>
                    </div>
                ...
                <div class="stats-grid" style="margin-bottom:0;">
                    ...
                    <div class="stat-card">
                        ...
                        <p class="stat-value" id="previewLogStatus" style="font-size:22px;">Submitted</p>
                    </div>
...
function updateFacultyLogPreview() {
    ...
    document.getElementById('previewLogStatus').innerText = formatText(logStatus ? logStatus.value : 'submitted');
    document.getElementById('previewApproval').innerText = formatText(approvalStatus ? approvalStatus.value : 'pending');
}
