...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Fee Installment</h2>

        <p class="admin-page-subtitle">
            Update installment amount, paid amount and due date
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.fee-installments.update', $feeInstallment->id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="admin-form-grid">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="student_id"
                            ...
                            @foreach($students as $id => $name)
                                <option value="{{ $id }}" {{ old('student_id', $feeInstallment->student_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="fee_structure_id"
                            ...
                            @foreach($feeStructures as $id => $name)
                                <option value="{{ $id }}" {{ old('fee_structure_id', $feeInstallment->fee_structure_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                        </select>
                ...
                @if($feeInstallment->payments()->exists())
                    <div class="form-info-box">
                        <p>
                            ...
                            {{ $feeInstallment->payments()->count() }} fee payment(s) are linked to this installment. Paid amount below is kept in sync automatically whenever a linked payment changes.
                        </p>
                    </div>
                @endif
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $feeInstallment->title) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number"
                               ...
                               name="paid_amount"
                               id="paid_amount"
                               value="{{ old('paid_amount', $feeInstallment->paid_amount) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="date"
                               name="due_date"
                               id="due_date"
                               value="{{ old('due_date', $feeInstallment->due_date ? \Carbon\Carbon::parse($feeInstallment->due_date)->format('Y-m-d') : '') }}"
                ...
                <input type="hidden" name="status" value="{{ old('status', $feeInstallment->status) }}">
