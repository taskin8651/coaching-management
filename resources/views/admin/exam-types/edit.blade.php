...
@section('page-title', 'Edit Exam Type')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Exam Type</h2>

        <p class="admin-page-subtitle">
            Update exam/test type details
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.exam-types.update', $examType->id) }}">
    @csrf
    @method('PUT')
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <textarea name="description"
                              ...
                              class="field-input {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $examType->description) }}</textarea>
