...
class PermissionsTableSeeder extends Seeder
{
    public function run()
    {
        $permissions = [
            ...
            'student_fee_ledger_access',
            'student_fee_ledger_show',
            'student_fee_ledger_create',
            ...
            'event_certificate_mark',
            'event_fee_rule_manage',
            'event_payment_collect',

            'external_contact_access',
            'external_contact_create',
            'external_contact_edit',
            'external_contact_show',
            'external_contact_delete',
